...
namespace pTK
{
    ...
    public:
        ...
        */
        void onInput(const std::function<bool(const std::unique_ptr<uint32[]>&, std::size_t, Text::Encoding)>& callback);
        ...
        */
        ...
        [[nodiscard]] const std::vector<std::function<bool(const std::unique_ptr<uint32[]>&, std::size_t, Text::Encoding)>>& getKeyInputCallbacks() const;
        ...
        [[nodiscard]] std::vector<std::function<bool(const std::unique_ptr<uint32[]>&, std::size_t, Text::Encoding)>>& getKeyInputCallbacks();
    ...
    private:
        ...
        std::vector<std::function<bool(const std::unique_ptr<uint32[]>&, std::size_t, Text::Encoding)>> m_keyInputCallback;
