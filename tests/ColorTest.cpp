...
TEST_CASE("Correct Color Constructors")
{
    ...
    for (const auto& p : data)
    {
        ...
        SECTION("Color(uint8_t red, uint8_t green, uint8_t blue) " + valueStr +
                " input: " + std::to_string(p.first.all))
        {
        ...
        SECTION("Color(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha) " + valueStr +
                " input: " + std::to_string(p.first.all))
        {
...
TEST_CASE("Color Set")
{
    ...
    for (const auto& p : data)
    {
        ...
        SECTION("setRGB(uint8_t red, uint8_t green, uint8_t blue) " + valueStr +
                " input: " + std::to_string(p.first.all))
        {
            pTK::Color color;
        ...
        SECTION("setRGBA(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha) " + valueStr +
                " input: " + std::to_string(p.first.all))
        {
            pTK::Color color;
